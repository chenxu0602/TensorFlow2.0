...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0e\x66\x65\x61tures.proto\"\x1a\n\tBytesList\x12\r\n\x05value\x18\x01 \x03(\x0c\"\x1e\n\tFloatList\x12\x11\n\x05value\x18\x01 \x03(\x02\x42\x02\x10\x01\"\x1e\n\tInt64List\x12\x11\n\x05value\x18\x01 \x03(\x03\x42\x02\x10\x01\"w\n\x07\x46\x65\x61ture\x12 \n\nbytes_list\x18\x01 \x01(\x0b\x32\n.BytesListH\x00\x12 \n\nfloat_list\x18\x02 \x01(\x0b\x32\n.FloatListH\x00\x12 \n\nint64_list\x18\x03 \x01(\x0b\x32\n.Int64ListH\x00\x42\x06\n\x04kind\"m\n\x08\x46\x65\x61tures\x12\'\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x16.Features.FeatureEntry\x1a\x38\n\x0c\x46\x65\x61tureEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x17\n\x05value\x18\x02 \x01(\x0b\x32\x08.Feature:\x02\x38\x01\"&\n\x07\x45xample\x12\x1b\n\x08\x66\x65\x61tures\x18\x01 \x01(\x0b\x32\t.Features\"(\n\x0b\x46\x65\x61tureList\x12\x19\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x08.Feature\"\x86\x01\n\x0c\x46\x65\x61tureLists\x12\x34\n\x0c\x66\x65\x61ture_list\x18\x01 \x03(\x0b\x32\x1e.FeatureLists.FeatureListEntry\x1a@\n\x10\x46\x65\x61tureListEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\x1b\n\x05value\x18\x02 \x01(\x0b\x32\x0c.FeatureList:\x02\x38\x01\"S\n\x0fSequenceExample\x12\x1a\n\x07\x63ontext\x18\x01 \x01(\x0b\x32\t.Features\x12$\n\rfeature_lists\x18\x02 \x01(\x0b\x32\r.FeatureListsb\x06proto3'
)
...
_BYTESLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='BytesList.value', index=0,
...
_FLOATLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='FloatList.value', index=0,
...
_INT64LIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='Int64List.value', index=0,
...
_FEATURE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bytes_list', full_name='Feature.bytes_list', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='float_list', full_name='Feature.float_list', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int64_list', full_name='Feature.int64_list', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='Feature.kind',
...
_FEATURES_FEATUREENTRY = _descriptor.Descriptor(
  name='FeatureEntry',
  full_name='Features.FeatureEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Features.FeatureEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='Features.FeatureEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='Features.feature', index=0,
...
_EXAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='features', full_name='Example.features', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELIST = _descriptor.Descriptor(
  name='FeatureList',
  full_name='FeatureList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='FeatureList.feature', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS_FEATURELISTENTRY = _descriptor.Descriptor(
  ...
  full_name='FeatureLists.FeatureListEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='FeatureLists.FeatureListEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='FeatureLists.FeatureListEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS = _descriptor.Descriptor(
  name='FeatureLists',
  full_name='FeatureLists',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature_list', full_name='FeatureLists.feature_list', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEQUENCEEXAMPLE = _descriptor.Descriptor(
  ...
  full_name='SequenceExample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='context', full_name='SequenceExample.context', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='feature_lists', full_name='SequenceExample.feature_lists', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Features = _reflection.GeneratedProtocolMessageType('Features', (_message.Message,), {
  ...
  'FeatureEntry' : _reflection.GeneratedProtocolMessageType('FeatureEntry', (_message.Message,), {
    ...
    '__module__' : 'features_pb2'
    # @@protoc_insertion_point(class_scope:Features.FeatureEntry)
    })
  ,
...
FeatureLists = _reflection.GeneratedProtocolMessageType('FeatureLists', (_message.Message,), {
  ...
  'FeatureListEntry' : _reflection.GeneratedProtocolMessageType('FeatureListEntry', (_message.Message,), {
    ...
    '__module__' : 'features_pb2'
    # @@protoc_insertion_point(class_scope:FeatureLists.FeatureListEntry)
    })
  ,
